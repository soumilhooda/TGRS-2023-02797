...
!real                  :: hum1(33,23,3000000),hum2(33,23,3000000)
real                  :: tmp1(33,23,4000000),tmp2(33,23,4000000)
real                  :: prs1(33,23,4000000),prs2(33,23,4000000)
real                   :: blat(60),blon(60), points(33,23)
real                   :: xx(3000000),yy(3000000),diff(3000000)
...
open(999,file='tmp-err2020-train.grd',access='direct',recl=4*33*23)
!-----------------------------------------------
...
if(stat ==0)then
do
read(1,*,iostat=stat)alat,alon,hgt,bb1,bb2,cc1,cc2,mon
if(stat /=0)exit
...
do jj=1,nx
  do kk=1,ny
          icnt=points(jj,kk)
          if(icnt== 0)icnt=1
          xx(1:icnt)=tmp1(jj,kk,1:icnt)
          yy(1:icnt)=tmp2(jj,kk,1:icnt)
          !xx(1:icnt)=prs1(jj,kk,1:icnt)
          !yy(1:icnt)=prs2(jj,kk,1:icnt)
