...
real(kind=8)              :: aa1,aa2,bb1,bb2,cc1,cc2,hgt,alat,alon,mon
...
!open(991,file='profile-tmp20-train.ascii')
!open(992,file='profile-prs20-train.ascii')
!open(991,file='profile-tmp20-test.ascii')
!open(992,file='profile-prs20-test.ascii')
open(991,file='profile-tmp21-test.ascii')
open(992,file='profile-prs21-test.ascii')
