...
plt.xlabel('Bias(hPa)',fontsize=15)
...
#plt.ylabel('Height(Km)',fontsize=15)
plt.xlabel('RMSE(hPa)',fontsize=15)
plt.yticks(np.arange(00,  16, 1))
plt.xticks(np.arange(00, 0.8, 0.1))
plt.axvline(x=0, ymin=0, ymax=15, color='black')
...
#plt.ylabel('Height(Km)',fontsize=15)
plt.xlabel('Std.Dev(hPa)',fontsize=15)
plt.yticks(np.arange(00,  16, 1))
plt.xticks(np.arange(00, 0.8, 0.1))
plt.axvline(x=0, ymin=0, ymax=15, color='black')
plt.legend(loc='upper right', frameon=False, ncol=1)
...
#plt.grid()
plt.savefig('evp-bias-rmsd-std-profile.png', format='png', dpi=600)
plt.show()
